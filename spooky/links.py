...
def tmdb_watch_url(season: Any, movie_id: Any) -> str | None:
    """Films link to their TMDB movie page; episodes to the season watch page.
    ...
    season_number = as_int(season)
    if season_number is not None:
        return (
            f"https://www.themoviedb.org/tv/4087-the-x-files/season/{season_number}/watch"
        )
    return None
